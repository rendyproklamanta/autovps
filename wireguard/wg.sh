...
# ==================================================
# Link Hosting Kalian
rendyproklamanta="raw.githubusercontent.com/rendyproklamanta/autovps/main/wireguard"
...
# Tambahan
cd /usr/bin
wget -O addwg "https://raw.githubusercontent.com/rendyproklamanta/autovps/main/wireguard/addwg.sh"
wget -O delwg "https://raw.githubusercontent.com/rendyproklamanta/autovps/main/wireguard/delwg.sh"
wget -O renewwg "https://raw.githubusercontent.com/rendyproklamanta/autovps/main/wireguard/renewwg.sh"
chmod +x addwg
chmod +x delwg
chmod +x renewwg
cd
